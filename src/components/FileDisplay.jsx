  ...
  return (
    <main className="flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 w-72 sm:w-96  max-w-full mx-auto ">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <button className="specialbutton px-4 py-2 rounded-lg text-blue-400 flex items-center gap-2 font-medium">
          <p>Transcribe</p>
          <i className="fa-sharp-duotone fa-solid fa-pen-nib"></i>
        </button>
      </div>
    </main>
  );
