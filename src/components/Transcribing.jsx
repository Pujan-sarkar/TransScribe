...
export default function Transcribing(props) {
  ...
  return (
    <div className="flex items-center flex-1 flex-col justify-center gap-10 md:gap14 py-24 text-center pb-24 p-4">
      ...
      <div className="flex flex-col gap-2 sm:gap-4 max-w-[350px] mx-auto w-full">
        {[0, 1, 2].map((val) => {
          return (
            <div
              key={val}
